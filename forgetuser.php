...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card1">
			...
			<div class="card-body">
				<form action="forgetuser.php" method="POST" autocomplete="OFF">
					...
					<div class="input-group form-group">						
						<input type="text" class="form-control" name="color" placeholder="YOUR FAVORITE COLOR AS PER REGISTERATION">
					</div> <br>
...
if($un!="" && $emailid!=""  && $upas!=""){
	if($cpassword==$upas){
		$ser="SELECT * from user where username='$un' and emailid='$emailid'";
		$res=$con->query($ser);
if($res->num_rows>0){
