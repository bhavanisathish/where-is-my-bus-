...
<div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="ft"   placeholder="From Timing">
          </div>
        </div>
...
<div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="tt"  placeholder="To Timing">
          </div>
        </div>
...
$tt=$_POST["tt"];
$ss=$_POST["ss"];
$insert="INSERT INTO `bus` (`busno`, `fromplace`, `toplace`, `fromtimeplace`, `totimeplace`, `seat`) VALUES ('$bn','$fp','$tp','ft','tt','ss')";
if($con->query($insert)){
